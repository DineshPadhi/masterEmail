...
create table lang(
    ...
    body text not null,
    foreign key (template_id) references TemplateData(id)
) ENGINE = InnoDB CHARACTER SET = utf8;
insert into lang(template_id, templateCode, language, subject, body)
values (2, "happy diwali", 'English', 'aksa', "english body");
truncate table lang;
select *
from lang;
drop table lang;
select lang.tamplate_id,
    lang.templateCode,
    lang.subject,
    lang.body
from lang
    inner join TemplateData on lang.tamplate_id = TemplateData.id
where lang.language = 'hin';