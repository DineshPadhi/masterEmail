...
insert into lang(templateCode, language, subject, body)
values ("happy diwali", "eng", 'hello', "eng body"),
...
select lang.language,
    ...
    body
from lang
    inner join TemplateData on lang.templateCode = TemplateData.templateCode
where TemplateData.lang = 'hin';